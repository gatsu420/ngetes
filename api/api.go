...
import (
	...
	"github.com/gatsu420/ngetes/worker"
...
type weatherForecastResource struct {
	workers *worker.WeatherForecastWorkers
}

func newWeatherForecastResource(operations worker.WeatherForecastOperations) *weatherForecastResource {
	return &weatherForecastResource{
		workers: worker.NewWeatherForecastWorkers(operations),
	}
}
